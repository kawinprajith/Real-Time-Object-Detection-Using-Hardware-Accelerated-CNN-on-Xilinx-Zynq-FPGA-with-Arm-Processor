...
// ==============================================================
`timescale 1ns/1ps
(* DowngradeIPIdentifiedWarnings="yes" *) module cnn_accel_control_s_axi
#(parameter
...
localparam
    ...
    ADDR_IER          = 6'h08,
    ADDR_ISR          = 6'h0c,
    ADDR_IMG_DATA_0   = 6'h10,
    ADDR_IMG_DATA_1   = 6'h14,
    ADDR_IMG_CTRL     = 6'h18,
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_IMG_DATA_0: begin
                    rdata <= int_img[31:0];
                end
                ADDR_IMG_DATA_1: begin
                    rdata <= int_img[63:32];
                end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_IMG_DATA_0)
            int_img[31:0] <= (WDATA[31:0] & wmask) | (int_img[31:0] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_IMG_DATA_1)
            int_img[63:32] <= (WDATA[31:0] & wmask) | (int_img[63:32] & ~wmask);
    end
end
